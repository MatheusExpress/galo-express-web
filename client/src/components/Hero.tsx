...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-white via-white to-red-50 overflow-hidden flex items-center">
      {/* Decorative diagonal background */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-red-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-0 w-80 h-80 bg-orange-500/10 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-black leading-tight">
                Sua entrega em <span className="text-red-500">tempo recorde</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="bg-red-500 hover:bg-red-600 text-white font-bold text-lg h-14 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
              >
                Começar Simulação
              </Button>
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-red-500 text-red-500 hover:bg-red-50 font-bold text-lg h-14 rounded-lg"
              >
                Saiba Mais
              </Button>
            </div>
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="relative w-64 h-64 animate-bounce">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Bike className="w-40 h-40 text-red-500 drop-shadow-lg" />
                </div>
              </div>
