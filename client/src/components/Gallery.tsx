      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, i) => (
            <div
              key={i}
              className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 hover:border-orange-300 transition-colors text-center"
            >
        ...
        {/* Specialties */}
        <div className="mt-16 p-8 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg border border-orange-200">
